...
public class UserRestController {
    ...
    public ResponseEntity<UserDetails> createUser(@RequestBody UserCreationDTO userCreationDTO){
        UserDetails createdUser = userService.saveNewUser(new DatabaseUser(userCreationDTO.getUsername(),userCreationDTO.getPassword(),new String[]{"ADMIN"}));
        return new ResponseEntity<>(createdUser, HttpStatus.CREATED);
    }

    @PutMapping("/updateUser")
    public ResponseEntity<UserDetails> updateUser(@RequestBody UserCreationDTO userCreationDTO){
        UserDetails updatedUser = userService.updateUser(new DatabaseUser(userCreationDTO.getUsername(),userCreationDTO.getPassword(),new String[]{"USER"}));
