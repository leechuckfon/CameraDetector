...
public class SpeedTests {
    ...
    public void detectionSpeedOffenseTest() throws Exception {
        speedOffenseChecker.handleMessage(new CameraMessage(4,"1-ABC-123", LocalDateTime.now()));
        speedOffenseChecker.handleMessage(new CameraMessage(5,"1-ABC-123", LocalDateTime.now().plus(1000, ChronoUnit.MILLIS)));
